...
\item[\Opt{-d}, \Opt{\Dd dry-run}]
      ...
      With the option the program will do everything, but not write file. Be careful, if you switched \Opt{-m}, \Opt{\Dd merge-by-distance} option. With the option dry-run should go through all crystal structures. So, it can take time.
