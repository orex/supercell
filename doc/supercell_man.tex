...
\section{Description}
%%%%%%%%%%%%%%%%%%%%%
\Prog{supercell} reads the file \Arg{infile} and writes \Arg{outfile}. The
...
\item[\OptArg{-c }{balance-type}, \OptArg{--charge-balance=}{balance-type}]
      ...
      \begin{itemize}
         ...
         \item[form] Experimental. Formal charges from internal \Prog{openbabel} database. Current version of \Prog{openbabel} provides charges only for few elements. 
      \end{itemize}
