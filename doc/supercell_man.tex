...
\begin{description}\setlength{\itemsep}{0cm}
\item In case of huge (more than $10^9$) number of total combaintions \Prog{supercell} can work quite slow or even freeze. The situation most of the time appears with large supresses. Always try small cells first.
